...
let pasado = document.querySelectorAll(".pasado");
    ...
    fetch('data.json',options)
        ...
        .then(data => {
            actual.forEach((e, i) => {
                ...
                pasado[i].innerHTML = "Yesterday - " + data[i].timeframes.daily.previous +"hrs";
            })
        })
};
// daily function
            ...
            actual.forEach((f, i) =>
             {
                ...
                pasado[i].innerHTML = "Last Week - " + data[i].timeframes.weekly.previous + "hrs";
            }) 
        })
};
    ...
    fetch('data.json')
        ...
        .then(data =>{
            actual.forEach((g, i) => {
                ...
                pasado[i].innerHTML = "Last Month - " + data[i].timeframes.monthly.previous + "hrs";
            })
        })
};
